...
export default function TeacherSignupPage1({ onBack: _onBack, onLogin, onNext }: Page1Props) {
  ...
  const handleVerifyOtp = async () => {
    ...
    setIsLoading(true);
    try {
      // If available on backend, verify here.
      // await postJSON('/auth/verify-otp', { email, otp: verificationCode });
      setOtpVerified(true);
