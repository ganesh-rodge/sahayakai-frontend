          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-4">
              <button
                ...
                className="flex items-center gap-3 bg-dark-tertiary px-4 py-2 rounded-full hover:bg-gray-800 transition-colors"
          ...
          <>
            ...
            >
              ...
              <div className="p-4 border-t border-gray-800 space-y-3">
                <button
                  type="button"
                  onClick={() => { setIsSidebarOpen(false); navigate('/student/profile'); }}
                  className="flex items-center gap-3 bg-dark-tertiary px-4 py-3 rounded-lg hover:bg-gray-800 transition-colors w-full text-left"
                  aria-label="Open Profile"
                >
                  {profilePicture ? (
