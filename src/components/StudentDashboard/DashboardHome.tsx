    ...
    <div className="space-y-6">
      ...
      >
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-2xl font-bold text-green-400">{hoursStudied}h</span>
          </div>
        ...
        >
          ...
          <p className="text-xs text-gray-500">{weekData.progress}% of roadmap</p>
        </motion.div>
      </motion.div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-2xl font-bold text-blue-400">{weekData.progress}%</div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold mb-1">Current Week: {weekData.title}</h2>
            <p className="text-gray-400 text-sm">{weekData.lessonsCompleted} of {weekData.totalLessons} lessons completed</p>
          </div>
        </div>
